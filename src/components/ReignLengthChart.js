...
const ReignLengthChart = (props) => {
    ...
    function createBarChart() {
        ...
        let cause_keys = Object.keys(constClass.CAUSE_COLOUR).map(function (
            key
        ) {
            return key
        })
        let cause_values = Object.keys(constClass.CAUSE_COLOUR).map(function (
            key
        ) {
